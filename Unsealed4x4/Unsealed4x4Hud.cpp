...
AUnsealed4x4Hud::AUnsealed4x4Hud(const FObjectInitializer& ObjectInitializer) 
...
void AUnsealed4x4Hud::DrawHUD()
{
	...
	if( bHMDDeviceActive == false )
	{
		...
		AUnsealed4x4Pawn* Vehicle = Cast<AUnsealed4x4Pawn>(GetOwningPawn());
